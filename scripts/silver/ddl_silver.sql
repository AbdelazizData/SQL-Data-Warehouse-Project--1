/*
Description:
This script prepares the "silver" layer tables for a data warehouse.

It performs the following steps:
1. Drops existing tables if they already exist.
2. Recreates CRM and ERP tables with a standardized structure.
3. Adds a default column (dwh_create_date) to track record creation time.
*/
